...
class MyGUI:
    def __init__(self):
        ...
        self.label1 = tk.Label(self.frameTopo, text='Um', font=("Arial Bold", 30))
        self.label2 = tk.Label(self.frameTopo, text='Dois', font=("Arial Bold", 30))
        self.label3 = tk.Label(self.frameTopo, text='Três', font=("Arial Bold", 30))
        ...
        self.label4 = tk.Label(self.frameBase, text='Quatro', font=("Arial Bold", 30))
        self.label5 = tk.Label(self.frameBase, text='Cinco', font=("Arial Bold", 30))
        self.label6 = tk.Label(self.frameBase, text='Seis', font=("Arial Bold", 30))
