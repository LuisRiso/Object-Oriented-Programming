...
class MyGUI:
    def __init__(self):
        ...
        self.cbVar1.set(0) #0 inicia não marcado
        self.cbVar2.set(1) #1 inicia marcado
        self.cbVar3.set(0) #0 inicia não marcado
        ...
        self.okButton = tk.Button(self.frameBase, \
                      text='OK', command=self.mostraEscolha) #mostrar o que o usuário escolheu
        self.finalizaButton = tk.Button(self.frameBase, \
                      text='Finaliza', command=self.janela.destroy) #botão que encessa aplicação
