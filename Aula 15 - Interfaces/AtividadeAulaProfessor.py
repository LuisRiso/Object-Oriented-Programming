...
class GUI:
   def __init__(self):
      ...
      self.labelResult1 = tk.Label(self.frame3,text="Nada") #Label que vai pegar o que foi digitado pelo usuario na info1
      self.labelResult2 = tk.Label(self.frame3,text="Nada") #Label que vai pegar o que foi digitado pelo usuario na info1
