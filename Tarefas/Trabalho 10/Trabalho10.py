...
class Controller():       
    def __init__(self):
        ...
        self.clientesCadastrados = set() #gerenciar código já cadastrados para não permitir dois códigos iguais
    ...
    def salvaHandler(self, event):
        ...
        if codigoCli in self.clientesCadastrados:
            ...
            cliente = ModelCliente(nomeCli, emailCli, codigoCli) #criou uma instância de cliente --> objeto cliente resultante
