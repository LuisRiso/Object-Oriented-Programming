...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#VIEW DA FUNÇÃO 4 (geralmente view de cadastrar)
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#VIEW DA FUNÇÃO 5 (geralmente view de consultar)
...
#------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
#CONTROLADOR ARQUIVO2
class ControladorArquivo2:
    def __init__(self, controladorPrincipal):
        self.controladorPrincipal = controladorPrincipal
        self.listaDEOBJETOSDOCONTEXTO = []
    
    def NomedaFunçao4(self): #definindo as funções que são chamadas no controlador principal da main e que inicializaam as views de cada arquvio, ou seja, as janelas secundárias
